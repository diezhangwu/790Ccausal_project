...
#all
dat %>%
  dplyr::select(percent_female,percent_nonwhite,percent_foreign,percent_age_less15,percent_age_15to44,percent_age_45plus) %>%
...
dat %>%
  filter(trt==1) %>%
  select(percent_female,percent_nonwhite,percent_foreign,percent_age_less15,percent_age_15to44,percent_age_45plus) %>%
  summarise_all(list(mean = ~mean(.), sd = ~sd(.))) 
#control group
dat %>%
  filter(trt==0) %>%
...
#unadjusted model
mod.mort.nocov <- glm(ln_mortality_rate ~ trt_knot*t, data = dat)
...
#plot
fig_mort <- ggplot() +
  geom_point(aes(x = dat$t, y = dat$ln_mortality_rate),color="darkgrey") +
  geom_line(aes(x = dat.pred.nocov$t, y = y.mort.nocov),color="red") + # fitted line
  geom_line(aes(x = dat.pred.nocov.ct$t, y = y.mort.nocov.ct),color="red",linetype="dashed") +
  geom_vline(xintercept = 0, color = "blue") +
...
#infant mortality
#unadjusted model
mod.in.nocov <- glm(ln_mortality_under1_rate ~ trt_knot*t, data = dat)
#generate predicted values based on the model in order to create a plot
...
#plot
fig_in <- ggplot() +
  geom_point(aes(x = dat$t, y = dat$ln_mortality_under1_rate),color="darkgrey") +
  geom_line(aes(x = dat.pred.nocov$t, y = y.in.nocov),color="red") + # fitted line
  geom_line(aes(x = dat.pred.nocov.ct$t, y = y.in.nocov.ct),color="red",linetype="dashed") +
  geom_vline(xintercept = 0, color = "blue") +
...
#typhoid mortality
#unadjusted model
mod.ty.nocov <- glm(ln_typhoid_rate ~ trt_knot*t, data = dat)
#generate predicted values based on the model in order to create a plot
...
#plot
fig_ty <- ggplot() +
  geom_point(aes(x = dat$t, y = dat$ln_typhoid_rate),color="darkgrey") +
  geom_line(aes(x = dat.pred.nocov$t, y = y.ty.nocov),color="red") + # fitted line
  geom_line(aes(x = dat.pred.nocov.ct$t, y = y.ty.nocov.ct),color="red",linetype="dashed") +
  geom_vline(xintercept = 0, color = "blue") +
...
#diarrhea mortality
#unadjusted model
mod.di.nocov <- glm(ln_diarrhea_rate ~ trt_knot*t, data = dat)
#generate predicted values based on the model in order to create a plot
...
#plot
fig_di <- ggplot() +
  geom_point(aes(x = dat$t, y = dat$ln_diarrhea_rate),color="darkgrey") +
  geom_line(aes(x = dat.pred.nocov$t, y = y.di.nocov),color="red") + # fitted line
  geom_line(aes(x = dat.pred.nocov.ct$t, y = y.di.nocov.ct),color="red",linetype="dashed") +
  geom_vline(xintercept = 0, color = "blue") +
...
library(ggpubr)
# 1. Open jpeg file
jpeg("unadj_ITS.jpg", width = 12, height = 8, units = 'in', res = 500)
# 2. Create the plot
